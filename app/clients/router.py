...
async def get_client_services(
    ...
    return CaseAssignmentService.get_client_services(db, client_id)
...
async def update_client(
    ...
    return ClientMutationService.update_client(db, client_id, client_data)
...
async def update_client_services(
    ...
    return CaseAssignmentService.update_client_services(db, client_id, user_id, service_update)
...
async def delete_client(
    ...
    """Delete a client"""
    ClientMutationService.delete_client(db, client_id)
    return None
